            ...
            <div class="col-md-4">
              <div class="contact-icon text-center">
                <div class="single-icon">
                  ...
                  <p>
                    Email: montanacarwash@gmail.com<br>
                    <span>Web: www.montanacarwash.id</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="contact-icon text-center">
                <div class="single-icon">
                  ...
                  <p>
                    Jl. Raden Saleh No.35, RT.001/RW.005, Karang Tengah, Kec. Ciledug, <br>
                    <span>Kota Tangerang, Banten 15157</span>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="form contact-form">
                <form action="kritiksaran_member.php" method="post" role="form" class="php-email-form">
