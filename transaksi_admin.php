...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    ...
    <!-- ======= Transaksi Section ======= -->
    <div id="transaksi" class="pricing-area area-padding">
      <div class="container">
        <div class="row">
    ...
    <table border="2" class="table table-bordered table-striped table-hover">
        ...
        $batas   = 20;
			...
			$query_mysql = mysqli_query($conn,"SELECT * FROM `transaksi` limit $posisi,$batas")or die(mysql_error());
            ...
            <tr class="text-center">
                ...
                <td><?php echo $data['idmember_transaksi'] ?></td>
				        <td><?php echo $data['statuspembayaran_transaksi'] ?></td>
                <td><a type="button" class="btn btn-success" href="cetak_transaksi.php?id_transaksi=<?php echo $data['id_transaksi']; ?> " class="edit"> CETAK </a></td>
            </tr>
        <?php } ?>
    </table>
    ...
    <hr>
		...
		$query2     = mysqli_query($conn, "SELECT * FROM `transaksi`");
		...
		<div class="text-center">
			<ul class="pagination">
				...
				for($i=1; $i<=$jmlhalaman; $i++) {
					if ($i != $halaman) {
						echo "<li class='page-item'><a class='page-link' href='transaksi_admin.php?halaman=$i'>$i</a></li>";
					} else {
    ...
    <br>
    <div class="text-center"><a type="button" class="btn btn-success" href="tambah_transaksi.php">Tambah Transaksi</a>
    <br><br>
