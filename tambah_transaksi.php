	...
	<form method="post" action="tambah_transaksi_aksi.php">
		<table width="400px">
            <tr>
				...
				<td><input type="text" class="form_data" name="namapelanggan_transaksi"></td>
			</tr>
			<tr>
				<td>No. HP</td>
				<td><input type="text" class="form_data" name="nohp_transaksi"   onkeypress="return event.charCode >= 48 && event.charCode <=57"></td>
			</tr>
			<tr>
				<td>Mobil</td>
				<td><input type="text" class="form_data" name="mobil_transaksi"></td>
			</tr>
			<tr>
				<td>Plat Nomor</td>
				<td><input type="text" class="form_data" name="platnomor_transaksi"></td>
			</tr>
            <tr>
				<td>Jenis Pencucian</td>
				<td><select type="text" class="form_data" name="jeniscuci_transaksi">
            ...
            <tr>
				<td>Jenis Member</td>
				<td><select type="text" class="form_data" name="member_transaksi">
