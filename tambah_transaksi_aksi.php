...
if($member_transaksi=='Hidrolik')
{$harga='0';}
else if($member_transaksi=='Normal')
{$harga='0';}
else if($member_transaksi=='Tidak Member')
{if($jeniscuci_transaksi=='Bodi')
    {$harga='25000';}
if($jeniscuci_transaksi=='Normal')
    {$harga='30000';}
    if($jeniscuci_transaksi=='Hidrolik')
    {$harga='50000';}
}
