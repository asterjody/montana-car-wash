          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="well-middle">
              <div class="single-well">
                ...
                <p>
                Montana Car Wash adalah Tempat Pencucian Mobil yang terletak di Tangerang. Alamat entitas yang terdaftar adalah Jl. Raden Saleh No.35, RT.001/RW.005, Karang Tengah, Kec. Ciledug, Kota Tangerang, Banten 15157. 
                </p>
                <ul>
                  <li>
                    <i class="bi bi-check"></i> Tempat Pencucian Mobil
                  </li>
                  <li>
                    <i class="bi bi-check"></i> Bengkel Perawatan Mobil
                  </li>
                  <li>
                    <i class="bi bi-check"></i> Menjual Aksesoris dan Pengharum Mobil
                  </li>
                  <li>
                    <i class="bi bi-check"></i> Kafe
                  </li>
